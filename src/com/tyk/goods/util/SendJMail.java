...
public class SendJMail {
		...
		public static boolean sendMail(String email, String emailMsg) {
			...
			String from = "15589522296@163.com"; 				// 邮件发送人的邮件地址
			String to = email; 										// 邮件接收人的邮件地址
			final String username = "15589522296@163.com";  	//发件人的邮件帐户
			final String password = "tang1995";   					//发件人的邮件密码
